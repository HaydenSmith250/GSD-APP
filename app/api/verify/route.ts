...
import { awardXp, XP_VALUES, XP_PENALTIES } from '@/lib/gamification';
...
export async function POST(request: Request) {
    try {
        ...
        // 3. Call Gemini 3 Flash via OpenRouter
        let promptContext = '';
...
Respond strictly in JSON format:
{
  ...
  "coach_message": "string"
        ...
        // Append to checkins history array
        ...
        updateData.verification_image_url = imageUrl; // store latest
        ...
        if (result.verified) {
            ...
            if (checkinType === 'start') {
                ...
                // Award base XP for completing the task + photo verify bonus
            ...
            // If failed a periodic or end, we could penalize, but for now just fail the verification attempt.
            // The user can try uploading again.
            // If it's a hard fail, we could set status='failed'
        }
        ...
        // Save coach message to chat history as context
